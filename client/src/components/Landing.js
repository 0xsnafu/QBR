    ...
    return (
        <div className="grid grid-cols-12 gap-4">
            <div className='col-start-2 col-span-10 md:col-start-3 md:col-span-8 border-2 border-green-500 rounded p-8'>
                <div className="grid grid-cols-12 gap-4">
                    ...
                    <div className='col-span-12 md:col-span-4 md:col-start-9'>
                        <Link to={`/play`} onClick={() => dispatch(setInParty(false))}>
                            <button className='bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-full h-full text-xl md:text-3xl'>Play
                ...
                <div>
                    <p className={`${errorMsg.length > 0 ? 'block' : 'hidden'} text-red-500 font-bold text-center md:text-left`}>{errorMsg}</p>
                    ...
                    <button className='bg-purple-500 hover:bg-purple-700 text-white font-bold py-1 px-2 rounded text-md w-3/4 md:w-max mx-auto block md:inline mt-1 md:mt-0 md:ml-2'
                    ...
                    <Link to={`/play`} onClick={() => dispatch(setInParty(true))}>
                        <button className='bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded text-md w-3/4 md:w-max mx-auto block md:inline'>Party Play</button>
                    </Link>
